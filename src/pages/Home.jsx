  ...
  return (
    ...
    <div className="homeContainer">
      ...
      <div className="homeCam">
        ...
        <h3>Blurb</h3>
        <div>Blurb is a social media application utilizing React, MongoDB, GraphQL, Node and Express. This is a demonstration of CRUD capabilities with this tech stack.</div>
        </div>
      </div>
      </div>
